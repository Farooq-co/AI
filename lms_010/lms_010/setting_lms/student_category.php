...
<html lang="en">
<head>
  <title>Student Category Management</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <div class="input-group">
                  <input type="text" class="form-control" id="searchInput" placeholder="Search by Category Name" aria-label="Search">
            ...
            <div class="col-md-6 text-left">
              <button type="button" class="btn btn-primary btn-rounded btn-fw" style="margin-bottom: 10px;" data-toggle="modal" data-target="#addCategoryModal">
                Add New Category
              </button>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Student Categories</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody id="categoryTableBody">
                        <?php
                          ...
                          // Query to fetch student categories
                          $sql = "SELECT id, name, status, created_at, updated_at FROM student_category ORDER BY id DESC";
                              ...
                              echo "<td>
                                    <div class='dropdown'>
                                      ...
                                      <div class='dropdown-menu'>
                                        ...
                                        <a class='dropdown-item' href='#' onclick='toggleCategoryStatus(" . $row["id"] . ", \"" . ($row["status"] == 'Active' ? 'Inactive' : 'Active') . "\")'><i class='ti-exchange-vertical'></i> Mark as " . ($row["status"] == 'Active' ? 'Inactive' : 'Active') . "</a>
                                        <a class='dropdown-item' href='#' onclick='deleteCategory(" . $row["id"] . ")'><i class='ti-trash'></i> Delete</a>
                                      </div>
                                    </div>
                                    </td>";
        ...
        <form id="addCategoryForm">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="categoryName" name="name" required placeholder="Enter category name (e.g., General, OBC, SC, ST, etc.)">
            </div>
            <div class="form-group">
  ...
  <script>
    ...
    function searchTable() {
      ...
      for (let i = 0; i < rows.length; i++) {
        const nameCell = rows[i].getElementsByTagName('td')[2]; // Category name is 3rd column (index 2)
        if (nameCell) {
    ...
    document.getElementById('addCategoryForm').addEventListener('submit', function(e) {
      ...
      fetch('student_category/add_student_category.php', {
        method: 'POST',
        body: formData
      })
    ...
    document.getElementById('editCategoryForm').addEventListener('submit', function(e) {
      ...
      fetch('student_category/edit_student_category.php', {
        method: 'POST',
        body: formData
      })
      .then(response => response.json())
    ...
    function toggleCategoryStatus(id, newStatus) {
      Swal.fire({
        title: 'Are you sure?',
        text: `Do you want to mark this category as ${newStatus}?`,
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          fetch('student_category/toggle_student_category_status.php', {
            method: 'POST',
            headers: {
    ...
    function deleteCategory(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          fetch('student_category/delete_student_category.php', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
