        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 text-left">
              <?php if (!empty($allowedModules['Products']['can_add'])) : ?>
                <button type="button" class="btn btn-primary btn-rounded btn-fw" style="margin-bottom: 10px;" data-toggle="modal" data-target="#addBookModal">
                  Add New Book
                </button>
              <?php endif; ?>
            </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody id="bookTableBody">
                        <?php
                          ...
                          $sql = "SELECT id, name, status FROM books WHERE status IN ('Active', 'Inactive')";
                          ...
                          if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                              ...
                              if (!empty($allowedModules['Products']['can_edit'])) {
                                  echo "<a class='dropdown-item' href='#' onclick='editBook(\"{$row['id']}\")'><i class='bi bi-pencil'></i> Edit</a>";
                              ...
                              if (!empty($allowedModules['Products']['can_delete'])) {
                                  echo "<a class='dropdown-item' href='#' onclick='deleteBook(\"{$row['id']}\")'><i class='bi bi-trash'></i> Delete</a>";
                              }
