            ...
            <div class="content-wrapper" style="padding: 15px;">
                <div class="container-fluid">
                    <form id="admissionForm" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" id="txtStudentID" name="txtStudentID" value="0">
                        <input type="hidden" id="txtGuardianID" name="txtGuardianID" value="0">
                        ...
                        <div class="d-flex justify-content-end mb-3" style="gap: 5px;">
                            ...
                            <div id="SaveButton" class="text-end">
                                <button type="button" class="btn btn-clear-guardian" onclick="saveStudentInfo();"><i class="bi bi-save me-1"></i> Save Student</button>
                            </div>
                            <div id="ClearButton" class="text-end" style="display: none;">
                                <button type="button" class="btn btn-clear-guardian" onclick="resetForm();"><i class="bi bi-plus-circle me-1"></i> Add New Student</button>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0" style="color: white !important;">
                                    <i class="bi bi-person-badge me-2" style="color: white !important;"></i>
                                    Add New Student
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="txtAdmissionDate" name="txtAdmissionDate" value="<?= $currentDate; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>ADMISSION NUMBER</label>
                                            <input type="text" id="txtAdmissionNumber" name="txtAdmissionNumber" class="form-control" placeholder="Admission Number" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="required-field">STUDENT NAME</label>
                                            <input type="text" id="txtStudentName" name="txtStudentName" class="form-control" placeholder="Student Name" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="required-field">FATHER NAME</label>
                                            <input type="text" id="txtFatherName" name="txtFatherName" class="form-control" placeholder="Father Name" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label for="txtDateOfBirth" class="required-field">DATE OF BIRTH</label>
                                            <input type="date" class="form-control" id="txtDateOfBirth" name="txtDateOfBirth" value="<?= $currentDate; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>ROLL NUMBER</label>
                                            <input type="text" id="txtRollNumber" name="txtRollNumber" class="form-control" placeholder="Roll Number">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="ddlReligionIdFk" name="ddlReligionIdFk" class="form-select">
                                                ...
                                                while ($religion = $religionResult->fetch_assoc()) {
                                                    echo '<option value="' . $religion['id'] . '">' . htmlspecialchars($religion['name']) . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="ddlGenderIdFk" name="ddlGenderIdFk" class="form-select">
                                                ...
                                                while ($gender = $genderResult->fetch_assoc()) {
                                                    echo '<option value="' . $gender['id'] . '">' . htmlspecialchars($gender['name']) . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="ddlBloodGroupIdFk" name="ddlBloodGroupIdFk" class="form-select">
                                                ...
                                                while ($blood = $bloodResult->fetch_assoc()) {
                                                    echo '<option value="' . $blood['id'] . '">' . htmlspecialchars($blood['name']) . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="txtAdmissionEffectiveDate" name="txtAdmissionEffectiveDate" value="<?= $currentDate; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>FAMILY NUMBER</label>
                                            <input type="text" id="txtFamilyNumber" name="txtFamilyNumber" class="form-control" placeholder="Family Number">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>HOBBIES</label>
                                            <textarea id="txtHobbies" name="txtHobbies" class="form-control" rows="2" placeholder="Hobbies"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>PLACE OF BIRTH</label>
                                            <textarea id="txtplaceofbirth" name="txtplaceofbirth" class="form-control" rows="2" placeholder="Place of Birth"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select id="ddlFeePackage" name="ddlFeePackage" class="form-select">
                                                ...
                                                while ($fee = $feeResult->fetch_assoc()) {
                                                    echo '<option value="' . $fee['id'] . '">' . htmlspecialchars($fee['name']) . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div id="currentImagePreview" class="image-preview-container" style="display:none;">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="border-warning-custom">
                                            ...
                                            <input type="text" class="form-control" id="StudentSearch1" name="StudentSearch1" maxlength="15" placeholder="XXXXX-XXXXXXX-X">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="border-warning-custom">
                                            <label>STUDENT SEARCH 002</label>
                                            <input type="text" class="form-control" id="StudentSearch2" name="StudentSearch2">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="border-warning-custom">
                                            <label>STUDENT SEARCH 003</label>
                                            <input type="text" class="form-control" id="StudentSearch3" name="StudentSearch3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="guardian-search-section">
                            ...
                            <div id="guardianInfoDisplay" style="display: none;"></div>
                        </div>
...
<script>
    ...
    function removeStudentPicture() { $('#StudentPicture').val(''); $('#currentImagePreview').hide(); $('#studentImagePreview').attr('src',''); Swal.fire('Info','Picture removed','info'); }
    function validateImageSize(input) { if(input.files && input.files[0]) { var fs = input.files[0].size; if(fs > 2*1024*1024) { $('#ImageSize').text('Max 2MB').show(); input.value=''; $('#currentImagePreview').hide(); } else { $('#ImageSize').hide(); var reader = new FileReader(); reader.onload = function(e) { $('#studentImagePreview').attr('src',e.target.result); $('#currentImagePreview').show(); }; reader.readAsDataURL(input.files[0]); } } }
    ...
    function updateStudentInfo() { 
        var required = ['#ddlSchoolClasses','#ddlSchoolClassSection','#txtAdmissionDate','#txtStudentName','#txtFatherName','#txtDateOfBirth','#ddlStudentCategoryIdFk','#ddlReligionIdFk','#ddlGenderIdFk','#txtAdmissionEffectiveDate']; 
        var valid=true; 
        ...
        var fd = new FormData(document.getElementById('admissionForm')); 
        fd.append('student_id',$('#txtStudentID').val()); 
        fd.append('guardian_id',$('#txtGuardianID').val()); 
        $('#loading-bar-spinner').show(); 
        $.ajax({ 
    ...
    function resetForm() { 
        ...
        $('#txtAdmissionDate').val(cd); 
        $('#txtAdmissionEffectiveDate').val(cd); 
        $('#txtDateOfBirth').val(cd); 
        $('#ddlSchoolClasses').val('0'); 
        $('#ddlSchoolClassSection').val('0'); 
        $('#ddlGroups').val('0'); 
        $('#ddlStudentCategoryIdFk').val('0'); 
        $('#ddlReligionIdFk').val('0'); 
        $('#ddlGenderIdFk').val('0'); 
        $('#ddlBloodGroupIdFk').val('0'); 
        $('#ddlFeePackage').val('0'); 
    ...
    function depositFee() { 
        ...
        if(sid=='0'){ 
            Swal.fire('Error','Save student first','error'); 
            return; 
        } 
        window.location.href='fee_collection.php?student_id='+sid; 
    }
    
    function updateFeePackage() { 
        var sid=$('#txtStudentID').val(); 
        var fp=$('#ddlFeePackage').val(); 
        if(sid=='0'){ 
            Swal.fire('Error','Save student first','error'); 
            return; 
        } 
        if(fp=='0'){ 
            Swal.fire('Warning','Select fee package','warning'); 
            return; 
        } 
        $.ajax({ 
            url:'ajax/update_fee_package.php', 
            type:'POST', 
            data:{student_id:sid, fee_package:fp}, 
            success:function(r){ 
                var d=JSON.parse(r); 
                if(d.success){ 
                    Swal.fire('Success',d.message,'success'); 
